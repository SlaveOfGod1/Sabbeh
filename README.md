...
![Sabbeh Logo](./assets/icon.png)

**A beautiful digital counter for your dhikr and prayers.**
...
- **Custom Color Picker**: Choose any color you like
...
4. **Run on your device**
   - Scan the QR code with [Expo Go](https://expo.dev/client) app
